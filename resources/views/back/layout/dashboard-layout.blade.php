...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>@yield('pageTitle') - Siswa</title>
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							> --}}
							<a class="dropdown-item" href="/halaman-login"
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li>
							<a href="/dashboard-siswa" class="dropdown-toggle no-arrow">
