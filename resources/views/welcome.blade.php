...
<head>
    ...
    <link rel="shortcut icon" href="/back/vendors/images/logo-rekapp.png" type="image/png">
...
<body>
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="landing">
                                <img src="/back/vendors/images/logo-landing.png" alt="">
                            </a>
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="dashboard">Home Ex</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(landing/images/banner-bg.svg)">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">REKAPP</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">SMK Wikrama Bogor</h2>
                            <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">Data keseharian Siswa selama di sekolah <br>
                                mencakup catatan kesalahan, absensi dan prestasi.
                            </p>
                            <a href="halaman-login" class="main-btn wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s">Login</a>
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="header-hero-image text-center wow fadeIn " data-wow-duration="1.3s" data-wow-delay="1.4s">
                            <img src="landing/images/header-hero.png" alt="hero">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="services-icon">
                            <img class="shape" src="landing/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="landing/images/services-shape-1.svg" alt="shape">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="services-icon">
                            <img class="shape" src="landing/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="landing/images/services-shape-2.svg" alt="shape">
                            <i class="lni-cog"></i>
                        </div>
                        <div class="services-content mt-30">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="services-icon">
                            <img class="shape" src="landing/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="landing/images/services-shape-3.svg" alt="shape">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="landing/images/about1.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="landing/images/about-shape-1.svg" alt="shape">
        </div>
    </section>
    ...
    <section class="about-area pt-70">
        <div class="about-shape-2">
            <img src="landing/images/about-shape-2.svg" alt="shape">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="landing/images/about2.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section class="about-area pt-70">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="landing/images/about3.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img class="dots" src="landing/images/dots.svg" alt="dots">
                        <div class="video-wrapper">
                            <div class="video-image">
                                <img src="landing/images/video.png" alt="video">
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="landing/images/team-1.png" alt="Team">
                            <div class="social">
                                <ul>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <img src="landing/images/team-2.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="landing/images/team-3.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing/images/author-1.png" alt="author">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing/images/author-2.png" alt="author">
                            </div>
                            <div class="author-content media-body">
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="landing/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="landing/images/author-3.png" alt="author">
                            </div>
                            <div class="author-content media-body">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="blog-image">
                            <img src="landing/images/blog-1.jpg" alt="blog">
                        </div>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="blog-image">
                            <img src="landing/images/blog-2.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="blog-image">
                            <img src="landing/images/blog-3.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="footer-about mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a class="logo" href="#">
                                <img src="landing/images/logo.svg" alt="logo">
                            </a>
...
-->
    ...
    <script src="landing/js/vendor/modernizr-3.7.1.min.js"></script>
    ...
    <!--====== Ajax Contact js ======-->
    <script src="landing/js/ajax-contact.js"></script>
    ...
    <!--====== Particles js ======-->
    <script src="landing/js/particles.min.js"></script>
