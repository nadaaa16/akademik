...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/">Rekap Akademik <span>SMK Wikrama Bogor</span></a>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
			<div class="col-md-4 d-flex ftco-animate">
				<div class="blog-entry justify-content-end">
					<div class="text px-4 py-4">
						<h3 class="heading mb-0"><a href="#" data-toggle="modal" data-target="#myModal">Juara 3 Futsal Championship 2023</a></h3>
					</div>
					<a href="#" class="block-20 position-relative" style="background-image: url('{{ asset('assets/images/juara3.png') }}');" data-toggle="modal" data-target="#myModal">
						<div class="text-center position-absolute" style="bottom: 10px; left: 50%; transform: translateX(-50%);">
							<p class="text-white mb-0">Klik untuk melihat lebih detail</p>
						</div>
					</a>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="myModalLabel">Juara 3 Futsal Championship 2023</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<!-- Isi modal berupa gambar -->
							<img src="{{ asset('assets/images/juara3.png') }}" alt="Juara 3 Futsal Championship 2023" class="img-fluid">
						</div>
			...
			<div class="col-md-4 d-flex ftco-animate">
				<div class="blog-entry justify-content-end">
					<div class="text px-4 py-4">
						<h3 class="heading mb-0"><a href="#" data-toggle="modal" data-target="#myModal1">Juara 1 Lomba Business Simulation Club Tahun 2023</a></h3>
					</div>
					<a href="#" class="block-20" style="background-image: url({{ asset('assets/images/juara1.png') }});" data-toggle="modal" data-target="#myModal1">
					</a>
					<div class="text p-4 float-right d-block">
						<div class="topper d-flex align-items-center">
							<div class="one py-2 pl-3 pr-1 align-self-stretch">
			...
			<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="myModalLabel1">Juara 1 Lomba Business Simulation Club Tahun 2023</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<!-- Isi modal berupa gambar -->
							<img src="{{ asset('assets/images/juara1.png') }}" alt="Juara 1 Lomba Business Simulation Club Tahun 2023" class="img-fluid">
							{{-- <p>Isi konten modal AAAAA...</p> --}}
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
						</div>
			...
			<div class="col-md-4 d-flex ftco-animate">
				<div class="blog-entry justify-content-end">
					<div class="text px-4 py-4">
						<h3 class="heading mb-0"><a href="#" data-toggle="modal" data-target="#myModal2">Juara 2 dalam lomba Bisnis Plan tingkat SMA/K Kota Bogor</a></h3>
					</div>
					<a href="#" class="block-20" style="background-image: url({{ asset('assets/images/juara2.png') }});" data-toggle="modal" data-target="#myModal2">
					</a>
					<div class="text p-4 float-right d-block">
						<div class="topper d-flex align-items-center">
							<div class="one py-2 pl-3 pr-1 align-self-stretch">
			...
			<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="myModalLabel2">Juara 2 dalam lomba Bisnis Plan tingkat SMA/K Kota Bogor</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<!-- Isi modal berupa gambar -->
							<img src="{{ asset('assets/images/juara2.png') }}" alt="Juara 2 dalam lomba Bisnis Plan tingkat SMA/K Kota Bogor" class="img-fluid">
							{{-- <p>Isi konten modal AAAAA...</p> --}}
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
