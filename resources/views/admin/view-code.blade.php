...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>Code Pelangaran - Admin</title>
	...
	<body>
					...
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Catatan</span>
							</a>
							<ul class="submenu">
								<li><a href="/add-code">Tambah Code</a></li>
								<li><a href="index2.html">Tambah Catatan</a></li>
		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                {{-- isi --}}
                <div class="xs-pd-20-10 pd-ltr-20">
                    <button class="btn btn-primary float-right" type="button">Tambah Code</button>
                </div>
				<div class="card-box pb-10">
					<table class="data-table table nowrap">
						<thead>
							<tr>
								<th class="table-plus">Nama Code Pelanggaran</th>
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="txt">
											<div class="weight-600">K 1.5 - Nongkrong</div>
										</div>
									</div>
								</td>
								<td>
