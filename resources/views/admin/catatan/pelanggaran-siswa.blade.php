                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                {{-- <a href="/view-pelanggaran/{{$value->id}}" data-color="#0D9276"><i class="bi bi-eye-fill"></i></a> --}}
                                <a href="/view-pelanggaran/{{$value->id}}" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
